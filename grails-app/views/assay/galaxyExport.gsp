...
<html>
  ...
  <g:form name="assaySelect" action="sendToGalaxy">
    ...
    <g:submitButton name="submit" value="Send to galaxy" id="submit"/>
    <g:hiddenField name="GALAXY_URL" value="${galaxy_url}" />
    <g:hiddenField name="tool_id" value="${tool_id}" />
  </g:form>
  </body>
</html>