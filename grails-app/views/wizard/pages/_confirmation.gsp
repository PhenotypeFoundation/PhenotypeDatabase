...
<div id="accordion">
	...
	<div>
		...
		Not right? Click <wizard:ajaxButton name="toSamples" value="here" url="[controller:'wizard',action:'pages']" update="[success:'wizardPage',failure:'wizardError']" afterSuccess="onWizardPage()" class="prevnext" /> to go back to the subjects page and make corrections.
	</div>
	...
	<div>
		...
		Not right? Click <wizard:ajaxButton name="toAssays" value="here" url="[controller:'wizard',action:'pages']" update="[success:'wizardPage',failure:'wizardError']" afterSuccess="onWizardPage()" class="prevnext" /> to go back to the subjects page and make corrections.
	</div>
</div>
