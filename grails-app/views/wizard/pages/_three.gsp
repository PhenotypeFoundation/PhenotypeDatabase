...
%>
<wizard:pageContent>
<wizard:textFieldElement name="myZero" value="12" help="some help text" maxlength="4">more than four?</wizard:textFieldElement>
<wizard:textFieldElement name="myFirstName" value="my value" help="my help">Please fill in you name bla bla bla</wizard:textFieldElement>
<wizard:textFieldElement name="mySecondName" value="1234" size="4">another text field</wizard:textFieldElement>
<wizard:textFieldElement name="myThirdName" value="a lotta description" help="so much for help">
