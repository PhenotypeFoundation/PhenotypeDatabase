...
<g:if env="development">
	<p>
		Welcome to GSCF version <b>${meta(name: 'app.version')}</b>. At this moment, there are ${studyCount} studies and ${userCount} users in the database.
	</p>
	<p>
	...
	<g:oauthLink consumer='myExperiment' returnTo="[controller: 'home', action: 'index']">Authorize</g:oauthLink>
	<g:hasOauthError>
		<div class="errors">
			<g:renderOauthError/>
		</div>
