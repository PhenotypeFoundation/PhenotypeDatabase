...
<div id="simpleQuery" class="simplequery">
	...
	<div class="searchContainer">
		<div class="search">
		 <div class="begin"><span class="label">Search term</span></div><div class="middle"><g:textField name="search_term" class="searchfield" value="${preterm}"/></div><div class="end"><a onClick="$('#search_term').val('');"><img src="${resource(dir: 'images', file: 'simpleQuery/spotlight-end.png')}" value="Reset" alt="Reset" border="0"></a></div><div class="submit"><g:submitButton name="search" value=""/></div>
		</div>
	</div>
	</g:form>
