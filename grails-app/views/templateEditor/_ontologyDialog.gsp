<ul id="addOntology">
  <li onClick="$('#searchType_ncbo').attr( 'checked', true ); $( '#termID' ).val( '' );">
	...
	<img id="ncbo_spinner" src="${createLinkTo( dir: 'images', file: 'spinner.gif' )}" style="margin-left: 5px; display: none;">
  </li>
  <li onClick="$('#searchType_term').attr( 'checked', true ); $( '#ncboIDText' ).val( '' );">
	...
	<img id="term_spinner" src="${createLinkTo( dir: 'images', file: 'spinner.gif' )}" style="margin-left: 5px; display: none;">
  </li>
</ul>
