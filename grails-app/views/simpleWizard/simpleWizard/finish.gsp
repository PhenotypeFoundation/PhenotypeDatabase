...
<body>
	<div class="simpleWizard">
		...
		<p class="options">
			<g:link class="view" controller="study" action="show" id="${study.id}">View this study</g:link>
			<g:link class="edit" controller="simpleWizard" action="index" id="${study.id}">Edit this study</g:link>
