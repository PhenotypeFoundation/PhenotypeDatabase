<span class="steps">
	...
	<g:else>
		<g:if test="${study?.id && study?.getSubjectCount()}">
	...
	<g:else>
		<g:if test="${study?.id && ( study?.getSubjectCount() || study?.getSampleCount() )}">
	...
	<g:else>
		<g:if test="${study?.id && ( study?.getSampleCount() || study?.getAssayCount() )}">
