...
class DataService {
    ...
    /**
     * Format the data contained in the input parameter 'collectionOfFields' for use as so-called fields, that will be used by the user interface to allow the user to select data from GSCF for visualization
