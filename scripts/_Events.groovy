...
def getEnvProperties() {
    ...
    properties['env.os.name'] = environment['environment.OS'] ?: environment['environment.OSTYPE'] ?: System.getProperty('os.name') ?: '-'
    properties['env.os.version'] = System.getProperty('os.version') ?: '-'
    properties['env.username'] = environment['environment.USERNAME'] ?: environment['environment.USER'] ?: System.getProperty('user.name') ?: '-'
    properties['env.computer'] = environment['environment.COMPUTERNAME'] ?: environment['environment.HOSTNAME'] ?: '-'
    properties['env.proc.type'] = environment['environment.PROCESSOR_ARCHITECTURE'] ?: environment['environment.HOSTTYPE'] ?: System.getProperty('os.arch') ?: '-'
